 ...
 */
$pi = array();
$pi["access"] = array("master_data", "functions");
$pi["filename_list"] = "functions.php";
$pi["filename_details"] = "function_details.php";
$pi["group"] = $lang["master_data"];
$pi["page"] = "list";
$pi["title"] = $lang["functions"];
$pi["template"] = "layout/pages/functions.tpl";
 ...
 */
$table = "functions";
$columns = "functions.value functions.id";
...
$sortlinks["value"] = generate_sortlink("functions.value", $lang["function"], $pi, $urlinfo);

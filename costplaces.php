...
$pi["page"] = "list";
$pi["title"] = $lang["costplaces"];
$pi["template"] = "layout/pages/costplaces.tpl";
 ...
 */
$table = "costplaces";
$columns = "costplaces.value costplaces.id";
...
$sortlinks["value"] = generate_sortlink("costplaces.value", $lang["costplace"], $pi, $urlinfo);
 ...
 */
if (isset($_POST["export"]) && $_POST["export"] == "yes") {
    $export_filename = "export_costplaces_" . date("Y-m-d_His") . ".xls";

...
/**
 * Report inactive garmentusers garments in use
 *
 ...
 * Page settings
 */
$pi["access"] = array("reports", "inactive_garmentusers_garments_in_use");
$pi["group"] = $lang["reports"];
$pi["title"] = $lang["inactive_garmentusers_garments_in_use"];
$pi["template"] = "layout/pages/report_inactive_garmentusers_garments_in_use.tpl";
$pi["page"] = "list";
$pi["filename_this"] = "report_inactive_garmentusers_garments_in_use.php";
$pi["filename_list"] = "report_inactive_garmentusers_garments_in_use.php";
...
$columns .= " garmentusers.id garmentusers.date_service_off garmentusers.active garmentusers.title garmentusers.gender garmentusers.initials garmentusers.intermediate garmentusers.surname garmentusers.name garmentusers.maidenname garmentusers.personnelcode";
...
if (!isset($urlinfo["where"][3])) {
    $urlinfo["where"][3] = "garmentusers.date_service_off isnot NULL AND garmentusers.date_service_off < " . date("Y-m-d") . " OR garmentusers.active <> 1";
}

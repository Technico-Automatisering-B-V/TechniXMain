...
<form name="dataform" id="mainform" enctype="multipart/form-data" method="POST" action="<?=$_SERVER["PHP_SELF"]?>">
    ...
    <div id="tabs">
        <ul>
            <li><a href="#tab1"><?=$lang["found_item"]?></a></li>
        </ul>
        ...
        <div id="tab1">
            <table class="detailstab">
                <tr>
                    ...
                    <td class="value"><input type="text" id="value" name="value" value="<?=$detailsdata["value"]?>" size="30" tabindex="1" /> <button class="required" title="<?=$lang["field_required"]?>">*</button></td>
                </tr>
            </table>
        </div>
    </div>

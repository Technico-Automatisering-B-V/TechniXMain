...
<div id="tabs">
    ...
    <?
        while ($row = db_fetch_assoc($c_groups)){ 
			...
			$tabs .= "<tr><td>Langer bij de drager:</td><td style=\"text-align: right;\"><strong><span id=\"data_gu_garment_value".$row["circulationgroup_id"]."\"></span></strong></td></tr>";
            $tabs .= "<tr><td>Langer in inname:</td><td style=\"text-align: right;\"><strong><span id=\"data_de_garment_value".$row["circulationgroup_id"]."\"></span></strong></td></tr>";
            $tabs .= "<tr><td>Langer in wasserij:</td><td style=\"text-align: right;\"><strong><span id=\"data_la_garment_value".$row["circulationgroup_id"]."\"></span></strong></td></tr>";
            $tabs .= "<tr><td>Langer op chaoot:</td><td style=\"text-align: right;\"><strong><span id=\"data_re_garment_value".$row["circulationgroup_id"]."\"></span></strong></td></tr>";			
			$tabs .= "</table></div>";
...
<script type="text/javascript">
    ...
    $.each(cgs, function (i, elem) {
        ...
        var currentChart = new Chart(chartInRoulationElement[elem-1], {
            type: 'pie',
            data: {
                labels: ['Beladen', 'Afgeworpen', 'Drager', 'Inname', 'Intern transport zkh', 'Transport naar wasserij', 'Wasserij'],
                datasets: [{
                    label: '# of Votes',
                    data: data_ir,
                    backgroundColor: [
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: ['Kleding in roulatie','totaal: '+totalInRoulation],
                    fontStyle: 'bold',
                    fontColor: 'black',
                    fontSize: 13
                },
        ...
        var currentChart = new Chart(chartLoadElement[elem-1], {
            ...
            options: {
                ...
                title: {
                    display: true,
                    text: ['Vullingsgraad van de machine', 'totaal: '+totalPosition],
                    fontStyle: 'bold',
                    fontColor: 'black',
                    fontSize: 13
                },
        ...
        var currentChart = new Chart(chartRoulationAdviceElement[elem-1], {
            type: 'pie',
            data: {
                labels: ['Gewenst', 'Bestellen', 'Te veel'],
                datasets: [{
					label: '# of Votes',
		...
		$.get( "dashboard_1.php", function( data ) {
                ...
                $.each(cgs, function (i, elem) {
                    ...
                    var currentChart = new Chart(chartOutRoulationElement[elem-1], {
                        type: 'pie',
                        data: {
                            labels: ['Nooit gescand', 'Vermist', 'Voorraad zkh', 'Voorraad bij wasserij', 'Thuiswassen', 'Reparatie', 'Ontvlekking', 'Ontkoppeld'],
                            datasets: [{
                                label: '# of Votes',
                                data: data_or,
                                backgroundColor: [
                        ...
                        options: {
                            ...
                            title: {
                                display: true,
                                text: ['Kleding uit roulatie','totaal: '+totalOutRoulation],
                                fontStyle: 'bold',
                                fontColor: 'black',
                                fontSize: 13
                            },
            ...
            var currentChart = new Chart(chartDistributionChartElement[elem-1], {
                ...
                options: {
                    ...
                    title: {
                        display: true,
                        text: 'Uitgiftesnelheid laatste week',
                        fontStyle: 'bold',
                        fontColor: 'black',
                        fontSize: 13
                    },
                ...
                $.each(cgs, function (i, elem) {
                    ...
                    var currentChart = new Chart(chartLoginElement[elem-1], {
                            ...
                            options: {
                                ...
                                title: {
                                    display: true,
                                    text: ['Aantal unieke aangemelde dragers','vandaag'],
                                    fontStyle: 'bold',
                                    fontColor: 'black',
                                    fontSize: 13
                                },
                ...
                $.each(cgs, function (i, elem) {
                    ...
                    var currentChart = new Chart(chartDistributionuserElement[elem-1], {
                            ...
                            options: {
                                ...
                                title: {
                                    display: true,
                                    text: ['Aantal uitgiftes', 'per drager per week'],
                                    fontStyle: 'bold',
                                    fontColor: 'black',
                                    fontSize: 13
                                },
                ...
                $.each(cgs, function (i, elem) {
                    ...
                    var currentChart = new Chart(chartDistributionstationElement[elem-1], {
                            ...
                            options: {
                                ...
                                title: {
                                    display: true,
                                    text: ['Aantal uitgiftes per station','vandaag'],
                                    fontStyle: 'bold',
                                    fontColor: 'black',
                                    fontSize: 13
                                },

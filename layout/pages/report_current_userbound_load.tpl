...
if ($result_count > 0)
{
    ...
    <table class="list">
        <tr class="listtitle">
            ...
            <?if($emplocle == "employees"){ print("<td class=\"list\">". $lang["article"] ."</td><td class=\"list\">". $lang["size"] ."</td><td class=\"list\">". $lang["number_carriers_posible"] ."</td><td class=\"list\">". $lang["number_carriers_taken"] ."</td>"); } ?>
